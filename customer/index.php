                                        ...
                                        <div class="main-nav">
                                            ...
                                            <div id="menu" class="collapse">
                                                <ul class="nav navbar-nav">
                                                    <li class="mega-menu"> <a href="../">Incio</a> <span class="arrow"></span></li>
                                                    <li class="mega-menu"> <a href="../shop.php">Productos</a> <span class="arrow"></span></li>
                                                    <li class="mega-menu"> <a href="../contact.php">Contáctanos</a> <span class="arrow"></span></li>
                                                    <li class="mega-menu active"> <a href="#">Mi Perfil</a> <span class="arrow"></span></li>
                                                    <li class="mega-menu"> <a href="../controller/login.close.php">Cerrar Sesión</a> <span class="arrow"></span></li>
                                    ...
                                    <div class="header-inner" style="height: 300px;">
                                        <div class="overlay">
                                            <div class="text text-center">
                                                <h3 class="uppercase text-white less-mar-1 title">Mi Perfil</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container">
                        <div class="row sec-padding hl-more-top-padd">
                            <div class="col-md-12 text-center">
                                <h3 class="uppercase less-mar-1 font-weight-5 raleway">Menú</h3>
                            </div>
                            <div class="col-md-12">
                                <!-- <div class=""> -->
                            ...
                            <div class="tab-content-holder-9">
                                <div class="responsive-tabs-content">
                                    <div id="example-1-tab-1" class="responsive-tabs-panel">
                                        ...
                                        <h1 style="text-align: center;">Bienvenido, <?php echo $name ?></h1>
                                        <!--end item-->
                                    </div>
                                    <!--end panel 1-->
                                    <div id="example-1-tab-2" class="responsive-tabs-panel col-xs-12">
                                        <section class="sec-padding ">
                                            <div class="container">
                                                <div class="col-md-12">
                                                    <div class="col-md-9 ">
                                                        <h4 class="uppercase">Actualizar datos</h4>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <div class="form-body bg-white enter-block ">
                                                        <form id="data_updateUser">
                                                            <div class="row ">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <label class="lable-text" for="email"> Correo</label>
                                                                    <input id="email" class="input-1" type="text" value="<?php echo $email ?>" name="email">
                                                                </div>
                                                                <div class="col-md-9">
                                                                    <label class="lable-text" for="email"> Teléfono</label>
                                                                    <input id="email" class="input-1" type="text" value="<?php echo $phone ?>" name="phone">

                                                                </div>
                                                                <div class="col-md-9">
                                                                    <label class="lable-text" for="email"> Dirección</label>
                                    ...
                                    <div id="example-1-tab-3" class="responsive-tabs-panel ">
                                        <section class="sec-padding ">
                                            <div class="container">
                                                <div class="col-md-12">
                                                    <div class="col-md-9 ">
                                                        <h4 class="uppercase">Actualizar clave</h4>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <div class="form-body bg-white enter-block ">
                                                        <form id="data_updateSecret">
                                                            <div class="row ">
                                                                <div class="col-md-9">
                                                                    <label class="lable-text" for="name"> Clave anterior</label>
                                                                    <input id="name" style="display: none;" class="input-1" type="text" placeholder="" value="<?php echo $id ?>" name="id">
                                                                    <input id="name" class="input-1" type="password" placeholder="" name="last">
                                                                </div>
                                                                <div class="col-md-9">
                                                                    <label class="lable-text" for="email"> Nueva clave</label>
                                                                    <input id="email" class="input-1" type="password" name="new">
                                                                </div>
                                                                <div class="col-md-9">
                                                                    <label class="lable-text" for="email"> Confirmar clave</label>
