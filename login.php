...
<body>
  ...
  <div class="loader">
                                ...
                                <div class="header-inner" style="height: 300px;">
                                    <div class="overlay">
                                        <div class="text text-center">
                                            <h3 class="uppercase text-white less-mar-1 title">Iniciar Sesión </h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="current"><a href="#">Iniciar sesión</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12 text-center">
                            <h4 class="uppercase">Formulario de inicio de sesión</h4>
                        </div>
                        <div class="clearfix"></div>
                        <br /> <br />
                        <div class="form-body border-light">
                            <form id="data_login">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="lable-text" for="name"> Correo</label>
                                        <input id="email" class="input-1" type="text" placeholder="Correo" name="email">
                                    </div>
                                    <div class="col-md-12">
                                        <label class="lable-text" for="email"> Clave</label>
                                        <input id="password" class="input-1" type="password" placeholder="Clave" name="secret">
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 text-left">
                                        <button class="btn btn-dark-3 btn-half-fullwidth uppercase" id="btn_login" type="submit">Login</button>
                                        <div class="col-md-12"><small><a href="#">Olvidó su contraseña?</a></small></div>
                            </form>
                        </div>
    ...
    <script src="js/_main/login.js"></script>
